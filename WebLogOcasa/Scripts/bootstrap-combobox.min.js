! function (t) {
   "use strict";
   var e = function (e, s) {
      this.options = t.extend({}, t.fn.combobox.defaults, s), this.template = this.options.template || this.template, this.$source = t(e), this.$container = this.setup(), this.$element = this.$container.find("input[type=text]"), this.$target = this.$container.find("input[type=hidden]"), this.$button = this.$container.find(".dropdown-toggle"), this.$menu = t(this.options.menu).appendTo("body"), this.matcher = this.options.matcher || this.matcher, this.sorter = this.options.sorter || this.sorter, this.highlighter = this.options.highlighter || this.highlighter, this.shown = !1, this.selected = !1, this.refresh(), this.transferAttributes(), this.listen()
   };
   e.prototype = {
      constructor: e,
      setup: function () {
      ...
      parse: function () {
         ...
         return this.$source.find("option").each(function () {
            var r = t(this);
            return "" === r.val() ? void (e.options.placeholder = r.text()) : (s[r.text()] = r.val(), i.push(r.text()), void (r.prop("selected") && (o = r.text(), n = r.val())))
         }), this.map = s, o && (this.$element.val(o), this.$target.val(n), this.$container.addClass("combobox-selected"), this.selected = !0), i
      },
      ...
      select: function () {
         ...
         return this.$element.val(this.updater(t)).trigger("change"), this.$target.val(this.map[t]).trigger("change"), this.$source.val(this.map[t]).trigger("change"), this.$container.addClass("combobox-selected"), this.selected = !0, this.hide()
      },
      updater: function (t) {
         return t
      },
      show: function () {
         ...
         return this.$menu.insertAfter(this.$element).css({
            top: e.top + e.height,
            left: e.left
         }).show(), t(".dropdown-menu").on("mousedown", t.proxy(this.scrollSafety, this)), this.shown = !0, this
      },
      hide: function () {
         return this.$menu.hide(), t(".dropdown-menu").off("mousedown", t.proxy(this.scrollSafety, this)), this.$element.on("blur", t.proxy(this.blur, this)), this.shown = !1, this
      },
      lookup: function (t) {
      ...
      sorter: function (t) {
         for (var e, s = [], i = [], o = []; e = t.shift();) e.toLowerCase().indexOf(this.query.toLowerCase()) ? ~e.indexOf(this.query) ? i.push(e) : o.push(e) : s.push(e);
         return s.concat(i, o)
      },
      ...
      fixMenuScroll: function () {
         ...
         if (t.length) {
            var e = t.position().top,
               ...
               o = this.$menu.height();
            s > o ? this.$menu.scrollTop(i + s - o) : e < 0 && this.$menu.scrollTop(i + e)
         }
      },
      keydown: function (e) {
      ...
      blur: function (t) {
         ...
         this.selected || "" === s || (this.$element.val(""), this.$source.val("").trigger("change"), this.$target.val("").trigger("change")), !this.mousedover && this.shown && setTimeout(function () {
            e.hide()
         }, 200)
      },
      click: function (t) {
   ...
   }, t.fn.combobox = function (s) {
      return this.each(function () {
         var i = t(this),
            o = i.data("combobox"),
            n = "object" == typeof s && s;
         o || i.data("combobox", o = new e(this, n)), "string" == typeof s && o[s]()
      })
